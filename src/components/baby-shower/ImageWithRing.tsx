...
const ImageWithRing: React.FC = () => {
  return (
    <div className="my-8 flex justify-center items-center animate-fadeIn animation-delay-[600ms] opacity-0">
      <div className="relative p-2 rounded-full animate-pulse-ring">
        <div className="w-48 h-48 sm:w-60 sm:h-60 rounded-full overflow-hidden shadow-xl border-4 border-white transform transition-transform duration-300 hover:scale-105">
          <Image
